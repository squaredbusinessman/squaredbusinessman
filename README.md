...
Я успешный выпускник Яндек Практикум на факультете "Веб-Разработчик". Я могу участвовать в ранних стадиях разработки, верстать HTML и CSS, писать скрипты на Vanilla JS, использовать React. Развиваться в области фронтенд разработки, стать гуру реакт, освоить Typescript и фреймворки VueJS, Angular.
